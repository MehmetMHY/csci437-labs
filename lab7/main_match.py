...
index_of_query_image = 6       # Should be in the range 2..6 inclusive
...
ratio_match_dist = 1.0      # Should be in the range (0..1]
##############
...
def main():
    ...
    print("Query image:", index_of_query_image)
    print("Ratio:", ratio_match_dist)
